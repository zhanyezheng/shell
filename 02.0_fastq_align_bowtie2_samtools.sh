...
bowtie2 --very-sensitive-local --mm -p 8 -x /f/mulinlab/zhanye/hic/00_hg19/bowtie2/hg19 -U /f/mulinlab/zhanye/project/R-loop/DRIP-seq/analysis/0-raw-data/k562.fastq.gz | samtools sort -@ 8 -m 1G -T /f/mulinlab/zhanye/project/R-loop/DRIP-seq/analysis/tmp/k562 -o /f/mulinlab/zhanye/project/R-loop/DRIP-seq/analysis/2-read-align/k562.sort.bam